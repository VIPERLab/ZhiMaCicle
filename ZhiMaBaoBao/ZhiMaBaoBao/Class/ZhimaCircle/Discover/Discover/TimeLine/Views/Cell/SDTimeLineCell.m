...
- (void)setModel:(SDTimeLineCellModel *)model
{
    ...
    [_iconView sd_setBackgroundImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",DFAPIURL,model.head_photo]] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"Discover_Photo_PlaceHolder"]];
