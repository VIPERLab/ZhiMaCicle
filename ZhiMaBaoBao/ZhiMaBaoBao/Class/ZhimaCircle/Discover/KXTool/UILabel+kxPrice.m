...
- (instancetype)initWithPrice:(NSString *)price andUnit:(NSString *)unit {
    self = [super init];
    if (self) {
        self.price = price;
        self.unit = unit;
...
- (void)titleWithPrice:(NSString *)price withPirceColor:(UIColor *)priceColor andUnit:(NSString *)unit withUnitColor:(UIColor *)unitColor {
    self.price = price;
    self.unit = unit;
