...
- (UIImageView *)shadowImageView {
    if (!_shadowImageView) {
        ...
        _shadowImageView.layer.cornerRadius = self.bounds.size.width/2;
        _shadowImageView.layer.masksToBounds = YES;
        _shadowImageView.layer.borderColor = WHITECOLOR.CGColor;
        _shadowImageView.layer.borderWidth = 1;
...
- (CAGradientLayer *)gradientLayer {
    if (!_gradientLayer) {
        ...
        _gradientLayer.colors = @[(id)[UIColor whiteColor].CGColor,(id)[UIColor whiteColor].CGColor];
//        _gradientLayer.colors = @[(id)[UIColor colorWithRed:249.0/255.0 green:80.0/255.0 blue:87.0/255.0 alpha:1.000].CGColor,(id)[UIColor colorWithRed:249.0/255.0 green:80.0/255.0 blue:87.0/255.0 alpha:1.000].CGColor];
